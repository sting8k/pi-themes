...
`neapple`, `neapple-light`, `monokai-pro`, `monokai-pro-light`, `onedark-pro`, `onedark-darker`, `onedark-pro-light`, `tokyo-dark`, `miasma`, `solarized-osaka`, `e-ink`, `e-ink-dark`, `gruvbox-light`, `noctis-lux`.
